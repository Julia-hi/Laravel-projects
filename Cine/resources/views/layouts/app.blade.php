...
<body>
            ...
            <div class="container">
                ...
                <img src="/images/logo.jpg" alt="" width="50">
                   <span> Cinemania</span>
                    ...
                    <a class="nav-link" href="{{ url('/#cartel') }}">Películas en cine</a>
                    @auth
                    @if(Auth::user()->rol=="admin")
                    <a class="nav-link" href="{{ url('/home') }}">Panel de admin</a>
                    @else
                    <a class="nav-link" href="{{ url('/user/'.$user->id.'/entradas') }}">Mis pedidos</a> 
                    @endif
                    @endauth
                    </ul>
    ...
    <div class="bg-dark full-screen bg-img pb-5"> 
        @yield("infoGeneral")
        ...
        @yield("pie")
            <footer id="sticky-footer" class="flex-shrink-0 py-4 bg-dark text-white-50">
                <div class="container text-center">
                    <small>Copyright &copy; Cinemania, 2022</small>
                </div>
            </footer>
    </div>
